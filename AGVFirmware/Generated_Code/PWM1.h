...
#define PWM1_PERIOD_VALUE              0x4188U /* Initial period value in ticks of the timer in high speed mode */
#define PWM1_PERIOD_VALUE_HIGH         0x4188U /* Period value in ticks of the timer in high speed mode */
