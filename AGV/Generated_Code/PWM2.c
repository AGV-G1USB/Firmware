...
**     Date/Time   : 2018-04-30, 14:16, # CodeGen: 9
**     Abstract    :
...
**             Xtal ticks              : 33         11
**             microseconds            : 1000       350
**             milliseconds            : 1          0
**             seconds (real)          : 0.000999987125 0.000349998474
**
**     Contents    :
...
static void SetRatio(void)
{
  if (ActualRatio == 0xFFFFU) {        /* Duty = 100%? */
    ...
    TPM3C1V = (word)(((0x4189UL * (dword)ActualRatio)  + 0x8000UL) >> 0x10U); /* Calculate new compare value according to the given ratio */
  }
}
...
void PWM2_Init(void)
{
  /* TPM3C1SC: CH1F=0,CH1IE=0,MS1B=1,MS1A=1,ELS1B=1,ELS1A=1,??=0,??=0 */
  setReg8(TPM3C1SC, 0x3CU);            /* Set up PWM mode with output signal level low */ 
  ActualRatio = 0x599AU;               /* Store initial value of the ratio */
